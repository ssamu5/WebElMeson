...
export const metadata: Metadata = {
  ...
  description: "Todo sobre El Mesón Smashburgers. Historia, valores, contacto y cómo llegar a Fustiñana, Navarra.",
};
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <p className="text-xs font-display uppercase tracking-[0.3em] text-brand-pink mb-4">Nuestra historia</p>
            <h2 className="font-display text-4xl sm:text-5xl uppercase tracking-wider text-[#F5F5F5] mb-6 leading-tight">
              La Leyenda de los Dioses
            </h2>
            <div className="space-y-4 text-[#F5F5F5]/80 text-sm leading-relaxed">
              <p>
                El Mesón nació con una obsesión: hacer la mejor smash burger de La Ribera. Con 4 años de experiencia y cientos de recetas probadas, hoy somos el referente de la smash burger artesanal en Navarra.
              </p>
              <p>
              ...
              <p className="font-display text-brand-pink uppercase tracking-wider text-base">
          ...
          <div className="relative aspect-square rounded-lg overflow-hidden">
            <Image
              src="/images/caja-exterior.webp"
              alt="El Mesón — Packaging"
              fill
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                text: "Viking aesthetic, nombres únicos, recetas que no encontrarás en ningún otro sitio de Navarra.",
              },
            ].map((val) => (
              <div
                key={val.title}
                className="glass-card rounded-lg p-6 hover:border-brand-pink/30 hover:shadow-[0_0_12px_rgba(232,24,154,0.15)] transition-all duration-300"
              >
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {[
              { src: "/images/caja-interior.webp", alt: "Caja interior El Mesón" },
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <ContactRow
                ...
                text={SITE_CONFIG.instagram.handle}
                external
              />
              <div className="pt-2">
              ...
              <div>
                ...
                <p className="text-[#F5F5F5] text-sm">{SITE_CONFIG.hours}</p>
              </div>
            </div>
